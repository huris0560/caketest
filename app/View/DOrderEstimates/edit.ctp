...
<?php echo $this->Form->create('DOrderEstimate'); ?>
	<fieldset>
		<legend><?php echo __('Edit D Order Estimate'); ?></legend>
	<?php
		echo $this->Form->input('order_estimate_cd');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DOrderEstimate.order_estimate_cd')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('DOrderEstimate.order_estimate_cd')))); ?></li>

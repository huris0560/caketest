...
<?php echo $this->Form->create('DCreditProc'); ?>
	<fieldset>
		<legend><?php echo __('Edit D Credit Proc'); ?></legend>
	<?php
		echo $this->Form->input('proc_no');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DCreditProc.proc_no')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('DCreditProc.proc_no')))); ?></li>
